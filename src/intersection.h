...
struct Path {
    PathVertex verts[MAX_DEPTH];
    Ray ray_list[MAX_DEPTH];
...
struct GraidentPTRadiance {
    Spectrum radiance = make_zero_spectrum();

    Spectrum contrib   = make_zero_spectrum();
    Spectrum contribX0 = make_zero_spectrum();
    Spectrum contribX1 = make_zero_spectrum();
    Spectrum contribY0 = make_zero_spectrum();
    Spectrum contribY1 = make_zero_spectrum();
